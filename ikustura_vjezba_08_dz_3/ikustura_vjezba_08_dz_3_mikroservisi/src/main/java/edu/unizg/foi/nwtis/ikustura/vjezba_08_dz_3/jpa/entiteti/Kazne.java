...
public class Kazne implements Serializable {
    ...
    public Kazne(long vrijemepocetak, long vrijemekraj, double brzina, double gpssirina, double gpsduzina, double gpssirinaradar, double gpsduzinaradar) {
    ...
    public String toString() {
        return "edu.unizg.foi.nwtis.ikustura.vjezba_08_dz_3.jpa.entiteti.Kazne[ rb=" + rb + " ]";
    }
}