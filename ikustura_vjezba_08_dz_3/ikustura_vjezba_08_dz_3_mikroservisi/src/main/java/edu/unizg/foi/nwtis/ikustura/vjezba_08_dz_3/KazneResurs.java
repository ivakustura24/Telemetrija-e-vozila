...
import edu.unizg.foi.nwtis.ikustura.vjezba_08_dz_3.jpa.entiteti.Kazne;
import edu.unizg.foi.nwtis.ikustura.vjezba_08_dz_3.jpa.pomocnici.KazneFacade;
...
public class KazneResurs {
  ...
  private boolean provjeriPosluzitelja() {
    ...
    var adresaKazne = config.get("app.kazne.adresa").asString().orElse("20.24.5.2");
    var mreznaVrataKazne = config.get("app.kazne.mreznaVrata").asInt().orElse(8020);
