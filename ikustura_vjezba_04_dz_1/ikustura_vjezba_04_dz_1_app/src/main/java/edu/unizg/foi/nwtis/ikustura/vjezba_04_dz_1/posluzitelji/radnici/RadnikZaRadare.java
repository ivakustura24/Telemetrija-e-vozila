...
public class RadnikZaRadare implements Runnable {
	 ...
	 */
	public RadnikZaRadare(Socket mreznaUticnica, 
			PodaciRadara podaciRadara, PosluziteljRadara posluziteljRadara) {
 ...
 * @return OK, ako je sve uredu, pogreška ako je neispravna sintaksa ili PosluziteljKazni nije aktivan
 */
...
/**
 * Obrada zahtjeva brzine - provjerava se vozi li vozilo brzo te koliko dugo, zapisuju se brza vozila i šalju zahtjevi (kazne) prema PosluziteljKazni
 *
...
public String obradaZahtjevaBrzine(String zahtjev) {
  ...
  private BrzoVozilo vratiBrzoVozilo(Matcher poklapanjeBrzine) {
    BrzoVozilo brzoVozilo = new BrzoVozilo(Integer.valueOf(this.poklapanjeBrzine.group("id")),
        -1, Long.valueOf(this.poklapanjeBrzine.group("vrijeme")),
        Double.valueOf(this.poklapanjeBrzine.group("brzina")),
        Double.valueOf(this.poklapanjeBrzine.group("gpsSirina")),
        Double.valueOf(this.poklapanjeBrzine.group("gpsDuzina")),
        true);
  return brzoVozilo;
}
  ...
  private String kreirajKomandu(BrzoVozilo postojeceVozilo, BrzoVozilo brzoVozilo) {
    ...
    append(postojeceVozilo.vrijeme()).append(" ").append(brzoVozilo.vrijeme())
    .append(" ").append(brzoVozilo.brzina()).append(" ").append(brzoVozilo.gpsSirina())
    .append(" ").append(brzoVozilo.gpsDuzina()).append(" ").append(this.podaciRadara.gpsSirina())
  ...
  /**
   * Ponisti podatke vozila - postavljanje statusa BrzoVozilo na false - 
   * u slučaju da je generirana kazna, vozilo smanjilo brzinu ili vozi 2 puta duže vremenski nego što radar dopušta
   *
