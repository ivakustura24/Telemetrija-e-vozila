...
public class Voznje implements Serializable {
    ...
    public Voznje(Integer rb, int broj, long vrijeme, double brzina, double snaga, double struja, double visina, double gpsbrzina, int tempvozila, int postotakbaterija, double naponbaterija, int kapacitetbaterija, int tempbaterija, double preostalokm, double ukupnokm, double gpssirina, double gpsduzina) {
        this.rb = rb;
        this.broj = broj;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Voznje)) {
            return false;
        }
        Voznje other = (Voznje) object;
    ...
    public String toString() {
        return "edu.unizg.foi.nwtis.ikustura.vjezba_08_dz_3.jpa.entiteti.Voznje[ rb=" + rb + " ]";
    }
