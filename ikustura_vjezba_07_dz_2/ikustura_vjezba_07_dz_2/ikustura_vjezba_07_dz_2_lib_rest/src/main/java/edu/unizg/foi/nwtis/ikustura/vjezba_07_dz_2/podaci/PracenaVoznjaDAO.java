...
public class PracenaVoznjaDAO {
  ...
  public List<Voznja> vratiPraceneVoznjeVozila(int id) {
    String upit = "SELECT id, broj, vrijeme, brzina, snaga, struja, visina, gpsBrzina, "
        ...
        + "preostaloKm, ukupnoKm, gpsSirina, gpsDuzina FROM pracenevoznje WHERE id = ?";
  ...
  public List<Voznja> vratiPraceneVoznjeInterval(long odVremena, long doVremena) {
    String upit = "SELECT id, broj, vrijeme, brzina, snaga, struja, visina, gpsBrzina, "
        + "tempVozila, postotakBaterija, naponBaterija, kapacitetBaterija, tempBaterija, "
        + "preostaloKm, ukupnoKm, gpsSirina, gpsDuzina FROM pracenevoznje WHERE "
        + "vrijeme >= ? AND vrijeme <= ?";
  ...
  public List<Voznja> vratiPraceneVoznjeVozilaInterval(int id, long odVremena, long doVremena) {
    String upit = "SELECT id, broj, vrijeme, brzina, snaga, struja, visina, gpsBrzina, "
        + "tempVozila, postotakBaterija, naponBaterija, kapacitetBaterija, tempBaterija, "
        + "preostaloKm, ukupnoKm, gpsSirina, gpsDuzina FROM pracenevoznje WHERE id = ? "
  ...
  public boolean dodajPracenuVoznju(Voznja voznja) {
    String upit =
