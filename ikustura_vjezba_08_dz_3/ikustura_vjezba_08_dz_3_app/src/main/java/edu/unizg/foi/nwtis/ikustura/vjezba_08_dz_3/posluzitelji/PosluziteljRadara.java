...
import edu.unizg.foi.nwtis.ikustura.vjezba_08_dz_3.posluzitelji.radnici.RadnikZaRadare;
...
public class PosluziteljRadara {
  ...
  private String obrisiRadar(String[] args) {
    ...
    var odgovor = MrezneOperacije.posaljiZahtjevPosluzitelju("20.24.5.2", 
        8000, komanda.toString());
    if(odgovor == null) {
   ...
   */
  public boolean registracijaPosluzitelja() {
	var komanda = new StringBuilder ();
	var razmak = " ";
...
//    var odgovor = MrezneOperacije.posaljiZahtjevPosluzitelju("localhost", 
//        8000, komanda.toString());
//	   var odgovor = MrezneOperacije.posaljiZahtjevPosluzitelju("20.24.5.2", 
//           8000, komanda.toString());
	if(odgovor == null) {
